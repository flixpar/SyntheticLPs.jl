...
- Regression (`lad`, `quantile`, `chebyshev`, `basis_pursuit`; dense statistical and weighted sparse-recovery LPs), Revenue Management (network DLP), Stochastic Program (two-stage with recourse)
