...
@testset "Process Planning" begin
    ...
    @test Set(list_variants(:process_planning)) ==
          Set([:refinery, :mode_switching, :capacity_expansion])
    ...
    @testset "Variable counts and sizing" begin
        ...
        for variant in (:refinery, :mode_switching, :capacity_expansion)
    ...
    @testset "Model structure" begin
        ...
        # Mode switching carries one run indicator per unit, mode and period.
        ...
        for target in (1, 5, 25), variant in (:refinery, :mode_switching,
                                              :capacity_expansion),
    ...
    @testset "Solver feasibility contracts" begin
        if HAS_HIGHS
            ...
            for variant in (:mode_switching, :capacity_expansion)
            ...
            outcomes = Set{Any}()
            for variant in (:refinery, :capacity_expansion), target in (200, 2000),
                seed in 0:5
